...
CREATE TABLE quantities(
    ...
    CONSTRAINT random UNIQUE (generator_id, token)
);
DESCRIBE quantities;
...
SELECT quantity, name, description, rate, base_cost, unlock_at
FROM generators,quantities
WHERE token = '80516ce4663c3bd0c8385309a2fe226e' AND generator_id = id;
